...
void setRotation(uint8_t m) {
    ...
    case 0:
        madctl = ST7735_MADCTL_MX | ST7735_MADCTL_MY |
            ST7735_MADCTL_BGR // Colors were inverted on the blue pcb so I added this from the adafruit st7735 lib to convert them back, if there is more inversion at other orientations change the rest to BGR.
            //ST7735_MADCTL_RGB
            ;
        _height = 160;
        _width = 128;

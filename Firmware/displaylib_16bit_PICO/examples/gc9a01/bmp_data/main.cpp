/*!
	@file   main.cpp
	@author Gavin Lyons
	@brief  Example cpp file for gc9a01 bitmap tests + FPS bitmap test.
...
void Test303(void)
{
	...
	myTFT.drawBitmap(70, 70, 128, 128, myTFT.C_WHITE, myTFT.C_GREEN, sArrowImage);
	MILLISEC_DELAY(TEST_DELAY5);
	myTFT.fillScreen(myTFT.C_BLACK);
}
...
void Test304(void)
{
	...
	myTFT.drawBitmap16Data(75, 75, sMotorImage, 128, 128);
	MILLISEC_DELAY(TEST_DELAY5);
	myTFT.fillScreen(myTFT.C_BLACK);
}
...
void Test305(void)
{
	...
	myTFT.drawBitmap16Data(70, 70, sPosterImage, 80, 48);
	MILLISEC_DELAY(TEST_DELAY5);
	myTFT.fillScreen(myTFT.C_BLACK);
}
...
void Test306(void)
{
	...
	myTFT.writeCharString(55, 55, teststr1);
	MILLISEC_DELAY(TEST_DELAY2);
	myTFT.drawBitmap8Data(70, 70, sColorTestImage, 96,96);
	MILLISEC_DELAY(TEST_DELAY5);
	myTFT.fillScreen(myTFT.C_BLACK);
}
...
void Test601(void)
{
	...
	while (1)
	{
		...
		//  ** Code to test **
		myTFT.drawBitmap16Data(70, 70, sMotorImage, 128, 128);
